...
import com.landi.utils.Base64Utils;
...
public class SM2 {
	...
	public static void main(String[] args) throws Exception {
		...
		SM2 sm02 = new SM2();
		 ...
		 ECPoint publicKey1 = sm02.curve.createPoint(px, py);
		 BigInteger privateKey2 = new BigInteger( "128B2FA8 BD433C6C 068C8D80 3DFF7979 2A519A55 171B1B65 0C23661D 15897263".replace(" ", ""), 16);
		...
		System.out.println("数字签名:" + Base64Utils.encode(signature.toString(),"UTF-8"));
